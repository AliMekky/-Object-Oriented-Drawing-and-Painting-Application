...
public class Rectangle extends Shape implements Cloneable {
	...
	public void drawShape(Graphics g) { // Covers all cases of the 4 quadrants and sets the color of the shape.
		...
		if (super.p.getX2() < super.p.getX1() && super.p.getY2() < super.p.getY1()) {
			g.drawRect(super.p.getX2(), super.p.getY2(), Math.abs(super.p.getX2() - super.p.getX1()),
					Math.abs(super.p.getY2() - super.p.getY1()));
	...
	@Override
	public Shape clone() {// Returns copy of the Rectangle.

		return new Rectangle(super.p.getX1(), super.p.getY1(), super.p.getX2(), super.p.getY2(), super.getC());
