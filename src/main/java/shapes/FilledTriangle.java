...
public class FilledTriangle extends Shape {
	...
	public FilledTriangle(int x1, int y1, int x2, int y2, Color c) {
		super(c, x1, y1, x2, y2);
	...
	@Override
	public Shape clone() { // returns a copy of the filled triangle.
		return new FilledTriangle(super.p.getX1(), super.p.getY1(), super.p.getX2(), super.p.getY2(), super.getC());

	}

	@Override
	public void save(BufferedImage image) {// Saves shape into an image.
