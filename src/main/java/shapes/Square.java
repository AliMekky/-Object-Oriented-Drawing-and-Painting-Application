...
public class Square extends Shape {
	...
	public Square(int x1, int y1, int x2, int y2, Color c) {
		super(c, x1, y1, x2, y2);
	...
	public void drawShape(Graphics g) {// Covers all cases of the 4 quadrants where (x1,y1) is considered the origin,
		...
		if (super.p.getX2() < super.p.getX1() && super.p.getY2() < super.p.getY1()) {
			g.drawRect(super.p.getX2(), super.p.getY2(), Math.abs(super.p.getX2() - super.p.getX1()),
					Math.abs(super.p.getX2() - super.p.getX1()));
		} else if (super.p.getX2() < super.p.getX1()) {
			g.drawRect(super.p.getX2(), super.p.getY1(), Math.abs(super.p.getX2() - super.p.getX1()),
					Math.abs(super.p.getX2() - super.p.getX1()));
		} else if (super.p.getY2() < super.p.getY1()) {
			g.drawRect(super.p.getX1(), super.p.getY2(), Math.abs(super.p.getX2() - super.p.getX1()),
					Math.abs(super.p.getX2() - super.p.getX1()));
		} else {
			g.drawRect(super.p.getX1(), super.p.getY1(), Math.abs(super.p.getX2() - super.p.getX1()),
					Math.abs(super.p.getX2() - super.p.getX1()));
		}
	...
	@Override
	public Shape clone() { // returns a copy of the Square.

		return new Square(super.p.getX1(), super.p.getY1(), super.p.getX2(), super.p.getY2(), super.getC());
