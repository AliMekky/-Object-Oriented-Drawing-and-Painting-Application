...
public class Circle extends Shape {
    ...
    public void drawShape(Graphics g) {//Covers all cases of the 4 quadrants where (x1,y1) is considered the origin, and sets the color.
        ...
        if (super.p.getX2() < super.p.getX1() && super.p.getY2() < super.p.getY1()) {
            g.drawOval(super.p.getX2(), super.p.getY2(), Math.abs(super.p.getX2() - super.p.getX1()), Math.abs(super.p.getX2() - super.p.getX1()));
        } else if (super.p.getX2() < super.p.getX1()) {
            g.drawOval(super.p.getX2(), super.p.getY1(), Math.abs(super.p.getX2() - super.p.getX1()), Math.abs(super.p.getX2() - super.p.getX1()));
        } else if (super.p.getY2() < super.p.getY1()) {
            g.drawOval(super.p.getX1(), super.p.getY2(), Math.abs(super.p.getX2() - super.p.getX1()), Math.abs(super.p.getX2() - super.p.getX1()));
        } else {
            g.drawOval(super.p.getX1(), super.p.getY1(), Math.abs(super.p.getX2() - super.p.getX1()), Math.abs(super.p.getX2() - super.p.getX1()));
        }
    ...
    public Shape clone() { //returns a copy of the circle.
    	return new Circle(super.getC(), super.p.getX1(), super.p.getY1(), super.p.getX2(), super.p.getY2());
